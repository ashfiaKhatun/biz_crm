                                ...
                                <tr>
                                        ...
                                        <form action="{{ route('ad-account.updateStatus', $adAccount->id) }}"
                                            ...
                                            <select name="status" class="form-control rounded"
                                                ...
                                                <option value="approved"
                                                    {{ $adAccount->status == 'approved' ? 'selected' : '' }}>Approved
                                                </option>
                                                <option value="canceled"
                                                    {{ $adAccount->status == 'canceled' ? 'selected' : '' }}>Canceled
                                                </option>
                                                <option value="rejected"
                                                    {{ $adAccount->status == 'rejected' ? 'selected' : '' }}>Rejected
                                                </option>
                                            </select>
                                        </form>
                                    </td>
                                    ...
                                    <td>
                                        <span>
                                            ...
                                            <form action="{{ route('ad-account.destroy', $adAccount->id) }}"
