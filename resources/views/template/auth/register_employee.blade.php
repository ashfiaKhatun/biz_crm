        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="w-75 mx-auto my-5 p-5 border rounded bg-white shadow-lg">
                ...
                <form method="POST" action="{{ route('register.employee') }}" class="my-3 login-input">

                    @csrf

                    <div>
                        <label class="col-form-label">Employee Name:</label>
                        <input id="name" class=" form-control rounded" type="text" name="name" :value="old('name')" placeholder="Employee Name" required autofocus autocomplete="name" />
                    ...
                    <div>
                        ...
                        <input id="email" class=" form-control rounded" type="email" name="email" :value="old('email')" placeholder="Employee Email" required autocomplete="username" />
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <input type="submit" name="submit" value="Add Employee" class="btn btn-sm btn-primary">
                    </div>
                </form>
            </div>
            <!-- #/ container -->
